...
# 单个
for file in *.pdb; do base="${file%.pdb}"; echo "正在处理: $file"; pdb2pqr --ff=AMBER --titration-state-method=propka --with-ph=7.0 --pdb-output="${base}_H.pdb" "$file" "${base}.pqr"; done; echo "所有文件批量质子化完成！"
